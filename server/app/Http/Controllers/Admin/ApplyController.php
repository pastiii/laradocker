...
class ApplyController extends BaseController
{
    ...
    public function CreateApply(Request $request)
    {
        ...
        $rule = [
            ...
            'file_one'               => 'required|string',
            'file_two'               => 'required|string',
            'file_three'             => 'required|string',
            'file_three_name'        => 'required|string',
            'file_two_name'          => 'required|string',
            'file_one_name'          => 'required|string',
        ];
        ...
        #储存数据
        $result = $this->apply_service->CreateApply($this->params, 1);
    ...
    public function EditApply(Request $request)
    {
        ...
        #储存数据
        $result = $this->apply_service->EditApply($this->params, 1);
    ...
    public function ApplyInit(Request $request)
    {
        ...
        #储存数据
        $result = $this->apply_service->ApplyInit($this->params);
    ...
    public function SaveApply(Request $request)
    {
        ...
        $rule = [
            ...
            'file_one'               => 'nullable|string',
            'file_two'               => 'nullable|string',
            'file_three'             => 'nullable|string',
            'file_three_name'        => 'nullable|string',
            'file_two_name'          => 'nullable|string',
            'file_one_name'          => 'nullable|string',
        ];
        ...
        #储存数据
        $result = $this->apply_service->SaveApply($this->params);
